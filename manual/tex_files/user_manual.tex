...
guide to install it and make it comatible with BOUT++ here.
\\
\\
\note{
It is important to note that if you do configure PETSc with SUNDIALS then BOUT
...
\\
%
It is also possible to get PETSc to download and install MUMPS
(see section \ref{sec:MUMPS}), by adding
%
\begin{verbatim}
--download-mumps \
--download-scalapack \
